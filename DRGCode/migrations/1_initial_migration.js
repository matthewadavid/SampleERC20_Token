const token = artifacts.require('../contracts/DRGToken.sol')
const crowdsale = artifacts.require('../contracts/DRGCrowdsale.sol')
const setDefaultAccount = require('../scripts/setDefaultAccount.js')

module.exports = function(deployer, network, accounts) {
    const rate = new web3.BigNumber(10)
    const wallet = '0x06471A19F4eFB66ecDDa77740a1EECECdd03b644'
    const cap = 1000000
